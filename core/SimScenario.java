...
public class SimScenario implements Serializable {
     ...
     * number of interface types -setting id ({@value})
     */
    public static final String NROF_NODE_GROUP_S = "nodesInGroups";
    /**
    ...
    int nrofGroups;
    /**
     *   * number of miners groups
     */
    int nrofNodeInGroups;
    /**
     * Width of the world
     */
...
//    }
    ...
    public Blockchain existingBlockchain;
    ...
    public int getNrofNodeInGroups() {
        return nrofNodeInGroups;
    }
    ...
    protected SimScenario() {
        ...
        this.nrofNodeInGroups = s.getInt(NROF_NODE_GROUP_S);
        ...
        ensurePositiveValue(nrofNodeInGroups, NROF_NODE_GROUP_S);
        ...
        this.existingBlockchain = new Blockchain(this.difficulty);
    ...
    protected void createHosts() {
        ...
        for (int i = 1; i <= nrofGroups; i++) {
            ...
            for (int j = 0; j < nrofHosts; j++) {
                ...
                if (host.toString().startsWith("int") || host.toString().startsWith("adm") || host.toString().startsWith("min")) {
